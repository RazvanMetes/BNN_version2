...
parser.add_argument('--modeldir', type=str, default='./out/models/', help='path where to save network\'s weights')
parser.add_argument('--logdir', type=str, default='./out/logs/', help='folder for tensorboard logs')
